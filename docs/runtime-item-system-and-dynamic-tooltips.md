...
For details on how Tooltips are displayed and how Item Manipulation is handled with respect to game rules and different UI panels, please see the **UI Interaction System** documentation (`docs/ui-interaction-system.md`).
